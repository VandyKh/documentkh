<?php 
Class Other_Form_FrmPeriod extends Zend_Dojo_Form {
	protected $tr;
	...
	public function FrmaddPeriod($_data=null){
		...
		$_value= new Zend_Dojo_Form_Element_NumberTextBox('value');
		$_value->setAttribs(array('dojoType'=>'dijit.form.NumberTextBox','required'=>'true','class'=>'fullside',));
